  ...
  return (
    ...
    <div className="Navbar">
      ...
      >
        ...
        <MenuItem onClick={handleClose} sx={{ fontSize: '15px',fontFamily: 'Poppins', color: 'black', backgroundColor: 'white', borderColor: '#d46f5e' }}><LogoutIcon />  <a href="/customer_logout"><b>LLogout</b></a></MenuItem>
      </Menu>
      </div>
    </div>
  );
