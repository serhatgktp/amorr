...
**Github:** https://github.com/UTSCCSCC01/finalprojects22-stackato-studio 
...
## summary.md (Max 8 marks)
  ...
  - Principles have been described clearly (max 2 marks)
    ...
    Your mark: 0
    Feedback: Missing section. Please check the rubric next time to ensure you haven't missed small sections.
...
## competition.md (Max 2 marks)
  ...
  Feedback: Since amorr intends to focus on providing beauty services, an important group of competitors are companies that provide at-home beauty services, i.e beautydel and bsidebeauty. Although they are not a marketplace like amorr, they are still an established competitor. 
  I also think amorr would be competing with general online marketplaces, i.e kijiji, fb marketplace and craigslist. All of these marketplaces also allow people to advertise and purchase services.
...
## Documentation: README.md (max 3 marks)
  ...
  - Installation for your Software/System
    ...
    Your mark: 1
    Feedback: Commands "to install npm" are incorrect.
...
## Personas.pdf (max 8 marks)
  ...
  - Quality of the persona should be measured based on the presence/absence quality of description of the following elements:
    ...
    - 0 marks = No personas provided
	  ...
	  Your mark: 3
    Feedback: Attitude towards technology missing for 2/3 personnas
...
## Process: process.md (max 10 marks)
  - Team organization (roles) divided clearly (max 2 marks)
    ...
    Your mark: 1
    Feedback: I think question was mis-interpreted. Team organization section was for describing what different team members worked on.
  ...
  - Prioritizing user stories (max 2 marks)
    ...
    Your mark: 1
    Feedback: The criteria is unclear. The way it's stated right now, the process only selects the story with the highest priority, whereas, every story needs to be assigned a priority. I think the intended criteria was to vote on the priority of a user story, and the priority with the most votes, or at least 4 votes, is assigned. 
...
---
## Total Mark  
Sprint 0 Total Mark : 42 / 48    Good Job!
